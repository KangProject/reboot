...
import cz.nuc.reboot.StreamGobbler.OnLineListener;
...
public class Shell {
	...
	public interface OnCommandResultListener {
		 ...
		 * 
		 * <p>See {@link cz.nuc.reboot.Shell.Interactive} for threading details</p>
		 * 
	...
	/**
	 * Builder class for {@link cz.nuc.reboot.Shell.Interactive}
	 */
	public static class Builder {
		 ...
		 * 
		 * <p>See {@link cz.nuc.reboot.Shell.Interactive} for further details on threading and handlers</p>
		 * 
		 ...
		 * 
		 * <p>The thread on which the callback executes is dependent on various factors, see {@link cz.nuc.reboot.Shell.Interactive} for further details</p>
		 * 
		 * @param command Command to execute
		...
		/**
		 * Construct a {@link cz.nuc.reboot.Shell.Interactive} instance, and start the shell
		 */
		public Interactive open() { return new Interactive(this); }
	}
	
	/**
	 * <p>An interactive shell - initially created with {@link cz.nuc.reboot.Shell.Builder} - that
	 ...
	 * {@link cz.nuc.reboot.Shell.OnCommandResultListener}. A work-around is to not supply this callback,
	 * but using (only) {@link cz.nuc.reboot.Shell.Builder#setOnSTDOUTLineListener(OnLineListener)}. This
	 ...
	 * supply a custom Handler using {@link cz.nuc.reboot.Shell.Builder#setHandler(android.os.Handler)} if needed.
	 * If you do not supply a custom Handler - unless you set {@link cz.nuc.reboot.Shell.Builder#setAutoHandler(boolean)}
	 ...
	 * 
	 * <p>The main thread must certainly has a Looper, thus if you call {@link cz.nuc.reboot.Shell.Builder#open()}
	 ...
	 * 
	 * <p>Background threads usually do <em>not</em> have a Looper, so calling {@link cz.nuc.reboot.Shell.Builder#open()}
	...
	public static class Interactive {		
		 ...
		 * See {@link cz.nuc.reboot.Shell.Interactive}
		 * 
